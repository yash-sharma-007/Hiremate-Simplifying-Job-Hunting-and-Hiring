...
<html>
    ...
    <body>
        ...
        <%
            ...
            if (request.getMethod().equals("POST")) {
                ...
                try {
                    ...
                    PreparedStatement ps = con.prepareStatement("SELECT password FROM emp WHERE username = ?");
                    ps.setString(1, user);
        ...
        <a href="employeeCreateAccount.jsp" class="create-account">Create Account</a>
